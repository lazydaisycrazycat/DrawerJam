...
export const levels: LevelConfig[] = [
  {
    ...
    trucks: [
      truck("red-1", 4, 1, "red", "down-left"),
      truck("blue-1", 0, 3, "blue", "up-right")
    ],
  ...
  },
  {
    ...
    trucks: [
      truck("green-1", 2, 4, "green", "up-right"),
      truck("red-2", 2, 2, "red", "down-right"),
      truck("blue-2", 0, 1, "blue", "up-left"),
      truck("decoy-2a", 4, 0, "yellow", "right"),
      truck("decoy-2b", 0, 4, "red", "down"),
      truck("decoy-2c", 3, 1, "yellow", "down-left")
    ],
  ...
  },
  {
    ...
    trucks: [
      ...
      truck("green-2", 4, 4, "green", "down-right"),
  ...
  },
  {
    ...
    trucks: [
      truck("green-5", 2, 5, "green", "up-right"),
      truck("yellow-5", 2, 3, "yellow", "down-right"),
      truck("red-5", 5, 2, "red", "down-left"),
      truck("blue-5", 0, 4, "blue", "up-right"),
